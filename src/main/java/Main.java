...
public class Main {
    ...
    public Main(Dictionary dictionary) throws JWNLException {
...
//        demonstrateSymmetricRelationshipOperation(FUNNY, DROLL);
    ...
    private void demonstrateTreeOpe0ration(IndexWord word) throws JWNLException {
